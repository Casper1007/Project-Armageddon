...
## Bonus-B Route53 + ACM Verification

```bash
# Confirm hosted zone exists (if managed in Terraform)
aws route53 list-hosted-zones-by-name \
  --dns-name chrisbarm-growl.com \
...
aws route53 list-resource-record-sets \
  ...
  --query "ResourceRecordSets[?Name=='app.chrisbarm-growl.com.']"
```
...
```bash
# Confirm HTTPS works
curl -I https://app.chrisbarm-growl.com
```
